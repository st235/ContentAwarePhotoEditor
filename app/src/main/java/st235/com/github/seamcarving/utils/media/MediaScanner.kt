...
sealed class MediaScanner(
    ...
    fun load(albumTitle: String, page: Page): List<MediaInfo> {
        val albumRegex = albumTitle.toRegex()

        val cursor = loadCursor(page) ?: return emptyList()
    ...
    protected abstract fun loadCursor(page: Page): Cursor?
...
class AndroidLMediaScanner(
    ...
    override fun loadCursor(page: Page): Cursor? {
        val what = arrayOf(
